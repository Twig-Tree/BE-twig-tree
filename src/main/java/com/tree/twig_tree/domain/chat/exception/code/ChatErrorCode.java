...
public enum ChatErrorCode implements BaseErrorCode {
    ...
    UNSUPPORTED_FILE_TYPE(HttpStatus.BAD_REQUEST, "CHAT400-4", "지원하지 않는 파일 형식입니다. txt 또는 md 파일만 업로드할 수 있습니다."),
    FILE_TOO_LARGE(HttpStatus.BAD_REQUEST, "CHAT400-5", "파일 크기가 상한(1MB)을 초과했습니다."),
    FILE_TEXT_TOO_LONG(HttpStatus.BAD_REQUEST, "CHAT400-6", "파일 내용이 너무 깁니다. 20,000자 이내로 줄여주세요."),
    FILE_EMPTY(HttpStatus.BAD_REQUEST, "CHAT400-7", "파일에 읽을 수 있는 내용이 없습니다."),
