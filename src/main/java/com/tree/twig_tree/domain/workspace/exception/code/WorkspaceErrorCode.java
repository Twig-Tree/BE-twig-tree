...
public enum WorkspaceErrorCode implements BaseErrorCode {
    ...
    WORKSPACE_NOT_FOUND(HttpStatus.NOT_FOUND, "WORKSPACE404-1","해당 노드가 존재하지 않습니다."),
    DUPLICATE_WORKSPACE_NAME(HttpStatus.BAD_REQUEST, "WORKSPACE400-1","같은 레벨에서 동일한 이름의 워크스페이스는 만들 수 없습니다."),
    WORKSPACE_NOT_INCLUDED_IN_FOLDER(HttpStatus.BAD_REQUEST, "WORKSPACE400-2","해당 폴더에 속하지 않은 워크스페이스입니다");
