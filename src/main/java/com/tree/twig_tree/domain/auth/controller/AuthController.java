...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<AuthResDTO.TokenPair>> reissue(@RequestBody @Valid AuthReqDTO.Reissue request) {
    ...
    public ResponseEntity<ApiResponse<Void>> logout(@RequestBody @Valid AuthReqDTO.Logout request) {
